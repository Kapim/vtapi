...
namespace vtserver {
 ...
 public:
    ...
    Status getEventColorDescriptor(ServerContext* context, const vtserver_interface::getEventColorDescriptorRequest* request, vtserver_interface::getEventColorDescriptorResponse* response);
