...
python -m grpc_tools.protoc --proto_path=$DIR/src/vtserver --python_out=$DIR/pyclient/vtclient --grpc_python_out=$DIR/pyclient/vtclient $DIR/src/vtserver/vtserver_interface.proto
